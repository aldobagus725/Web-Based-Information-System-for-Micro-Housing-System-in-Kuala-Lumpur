            ...
            <h2><a class="navbar-brand" href="http://localhost:8080/mhs_1/">
                ...
                <div class="collapse navbar-collapse navbar-main-collapse" id="NavNavbar">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/login/housingofficer">Login as Housing Officer</a></li>
                        <li class="nav-item"><a class="nav-link" href="/login/applicant">Login as Applicant</a></li>
                    </ul>
                </div>
        </nav>
