                    ...
                    <div class="row">
                        ...
                        {{method_field('PUT')}}
                                ...
                                <label> Full Name </label>
                                    <td><input type="text" name="fullname" value="{{$user->fullname}}" placeholder="Enter the FullName"></td>
                                 </div>

                                <div class="form-group">
                                <label> Username </label>
                                    <td><input type="text" name="username" value="{{$user->username}}" placeholder="Enter the Username"></td>
                                </div>

                                <div class="form-group">
                                <label> Monthly Income (Malaysian Ringgit) </label>
                                     <td><input type="text" name="monthlyIncome" value="{{$user->monthlyIncome}}" placeholder="Enter the Monthly Income"></td>
                                </div>
                                <br><br>
